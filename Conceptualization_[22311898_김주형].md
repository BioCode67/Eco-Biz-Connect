...
| 카테고리 | 요구사항 정의 | 세부 기준 |
| :--- | :--- | :--- |
| **성능 (Performance)** | 응답 및 처리 속도 | - [cite_start]DB 접근 후 데이터 출력 시간 3초 이내 [cite: 428, 800][cite_start]<br>- 페이지 로딩 및 화면 전환 속도 2초 이내 [cite: 429, 431] |
...
| **호환성 (Compatibility)** | 플랫폼 지원 범위 | - [cite_start]Android Lollipop (API 21) 이상 최신 버전 지원 [cite: 432, 798]<br>- iOS 14.0 이상 아이폰 환경 최적화 대응 |
