...
_LOAN_PRODUCT_CATALOG = [
    {
        "product_code": "EBC-SME-A",
        "bank_name": "중소벤처기업진흥공단",
        "product_name": "신성장기반자금 (혁신 소상공인)",
        "base_rate": 4.20,
    ...
    {
        "product_code": "EBC-SBC-B",
        "bank_name": "소상공인시장진흥공단",
        "product_name": "소상공인 혁신성장 정책자금",
        "base_rate": 4.50,
    ...
    },
    {
        ...
        "bank_name": "소상공인시장진흥공단",
        "product_name": "소상공인 정책자금 (일반경영안정자금)",
        "base_rate": 4.90,
    ...
    },
    {
        ...
        "bank_name": "IBK기업은행",
        "product_name": "IBK ESG 우수 소상공인 우대대출",
        "base_rate": 5.80,
        "max_amount": 100_000_000,
        "term_months": 60,
        "min_esg_grade": "B",
    ...
    {
        "product_code": "EBC-SHINHAN-C",
        "bank_name": "신한은행",
        "product_name": "소상공인 상생대출 (ESG 우대)",
        "base_rate": 6.30,
    ...
    {
        "product_code": "EBC-SUNSHINE-D",
        "bank_name": "지역신용보증재단",
        "product_name": "소상공인 햇살론 (보증부)",
        "base_rate": 7.90,
